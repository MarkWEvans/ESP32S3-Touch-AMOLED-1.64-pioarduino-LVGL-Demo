...
void lcd_lvgl_Init(void) {
  ...
  lv_color_t *buf1 =
      (lv_color_t *)heap_caps_malloc(EXAMPLE_LCD_H_RES * EXAMPLE_LVGL_BUF_HEIGHT * sizeof(lv_color_t), MALLOC_CAP_DMA);
  assert(buf1);
  lv_color_t *buf2 =
      (lv_color_t *)heap_caps_malloc(EXAMPLE_LCD_H_RES * EXAMPLE_LVGL_BUF_HEIGHT * sizeof(lv_color_t), MALLOC_CAP_DMA);
  assert(buf2);
...
#if (EXAMPLE_LVGL_ROTATION_DEG == 90)
  // Let LVGL rotate the rendered buffer before flushing to the panel.
  disp_drv.sw_rotate = 1;
  disp_drv.rotated = LV_DISP_ROT_90;
#elif (EXAMPLE_LVGL_ROTATION_DEG == 180)
  disp_drv.sw_rotate = 1;
  disp_drv.rotated = LV_DISP_ROT_180;
#elif (EXAMPLE_LVGL_ROTATION_DEG == 270)
  disp_drv.sw_rotate = 1;
